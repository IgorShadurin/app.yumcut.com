...
const EnvSchema = z.object({
  ...
  STRIPE_TOP_UP_75_PRICE_ID: z.string().min(1).optional(),
  STRIPE_TOP_UP_750_PRICE_ID: z.string().min(1).optional(),
  STRIPE_TOP_UP_1500_PRICE_ID: z.string().min(1).optional(),
  ...
  STRIPE_TOP_UP_SUCCESS_PATH: z.string().min(1).default('/account?topup=success'),
  STRIPE_TOP_UP_CANCEL_PATH: z.string().min(1).default('/account?topup=cancelled'),
  ...
  RESEND_MARKETING_EVENT_NAME: z.string().min(1).default('yumcut.marketing.email.v1'),
  RESEND_MARKETING_REPLY_TO_EMAIL: z.string().min(3).optional(),
  EMAIL_SEND_PROVIDER: z.enum(['postal', 'resend']).default('postal'),
  EMAIL_AUDIENCE: z.string().min(1).max(64).default('yumcut'),
  EMAIL_PREFERENCES_URL: z.string().url().default('https://mail.yumcut.com'),
  POSTAL_API_URL: z.string().url().optional(),
  POSTAL_API_KEY: z.string().min(1).optional(),
  POSTAL_FROM_EMAIL: z.string().min(3).optional(),
  POSTAL_WEBHOOK_PUBLIC_KEY: z.string().min(1).optional(),
