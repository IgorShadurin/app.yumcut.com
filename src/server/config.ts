...
const EnvSchema = z.object({
  ...
  EMAIL_SEND_PROVIDER: z.enum(['plunk', 'postal', 'resend']).default('plunk'),
  PLUNK_API_URL: z.string().url().default('https://mail-api.copymyui.com'),
  PLUNK_SECRET_KEY: z.string().min(1).optional(),
  PLUNK_FROM_EMAIL: z.string().min(3).optional(),
  PLUNK_PREFERENCES_URL: z.string().url().default('https://mail.yumcut.com'),
